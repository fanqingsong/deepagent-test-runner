...
async function navigateToRegister(page) {
    ...
    // Click "Create account" link to switch to registration
    const createAccountBtn = await page.$("text=Create account");
    if (createAccountBtn) {
...
async function runTests() {
    ...
    try {
        ...
        try {
            ...
            await page.fill("#register-email", "regtest@example.com");
        ...
        try {
            ...
            await page.fill("#login-email", "regtest@example.com");
        ...
        try {
            ...
            const hasError = await page.evaluate(() => {
                ...
                return errorMsg && errorMsg.textContent.includes("email");
            });
